...
class ConvGenerator(nn.Module):
    ...
    def forward(self, z):
        ...
        #
        # for i in range(64):
        #     x[i,:,:,:] = sorttt.sortt(self.s1, x[i,:,:,:].flatten()).reshape(64,64)[np.newaxis,:,:]
...
class ConvDiscriminator(nn.Module):
    ...
    def __init__(self,input_channels=1,dim=64,n_downsamplings=4,norm='batch_norm'):
        super().__init__()
